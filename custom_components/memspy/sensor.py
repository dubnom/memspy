...
async def async_setup_entry(
    ...
    """Set up Memspy sensors from a config entry."""
...
class _MemspyEntity(SensorEntity):
...
class SummarySensor(_MemspyEntity):
...
class TracemallocSensor(_MemspyEntity):
    ...
    def __init__(self, manager: ProfilerManager, entry: ConfigEntry) -> None:
        super().__init__(manager, entry)
        self._attr_name = "memspy_tracemalloc"
...
class TracemallocDurationSensor(_MemspyEntity):
    ...
    def __init__(self, manager: ProfilerManager, entry: ConfigEntry) -> None:
        super().__init__(manager, entry)
        self._attr_name = "memspy_tracemalloc_duration"
...
class ObjectSensor(_MemspyEntity):
